...
class Usuario {
    ...
    public function login($email, $senha) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if ($senhaValida) {
                ...
                $this->curso = $resultado['USUARIO_CURSO'];
    ...
    public function cadastrar() {
        ...
        $sql = "INSERT INTO USUARIO (USUARIO_NOME, USUARIO_EMAIL, USUARIO_SENHA, USUARIO_CPF, USUARIO_CURSO, TIPO_USUARIO, SETOR) 
                VALUES (:nome, :email, :senha, :cpf, :curso, :tipoUsuario, :setor)";
